...
class PaginaInicio extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Bordes de la App por Picasso"),
        centerTitle: true,
      ), //fin appbar
          ...
          child: Column(
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: Colors.indigo,
                  image: DecorationImage(image: NetworkImage("https://raw.githubusercontent.com/PedroPicasso3534/MisFotos/main/FotoPresentacion.jpg"), alignment: Alignment.topCenter),
                  border: Border(
                    top: BorderSide(
